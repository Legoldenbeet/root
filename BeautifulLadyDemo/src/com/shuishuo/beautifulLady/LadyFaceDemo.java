...
public class LadyFaceDemo {
	...
	private void initialize() {
		...
		frmAfc.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 18));
		...
		textField.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 24));
		...
		lblNewLabel.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 24));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frmAfc, ((JButton) e.getSource()).getText() + "ÕÍ≥…");
			}
		});
		btnNewButton.setUI(new BEButtonUI().setNormalColor(BEButtonUI.NormalColor.green));
		btnNewButton.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 24));
		...
		button.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 24));
		...
		button_1.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 24));
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frmAfc, "≥‰÷µ" + textField_4.getText() + label_4.getText() + "ÕÍ≥…");
				textField_4.requestFocusInWindow();
				textField_4.setText("");
			}
		});
		button_3.setUI(new BEButtonUI().setNormalColor(BEButtonUI.NormalColor.green));
		button_3.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 24));
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frmAfc, "◊Ó∫Û“ª± ≥‰÷µ≥Â’ÀÕÍ≥…");
			}
		});
		button_4.setUI(new BEButtonUI().setNormalColor(BEButtonUI.NormalColor.green));
		button_4.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 24));
		...
		button_5.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 24));
